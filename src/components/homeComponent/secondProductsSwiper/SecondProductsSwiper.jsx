...
import c from './SecondProductsSwiper.module.css'
...
const SecondProductsSwiper = () => {
    ...
    useEffect(() => {
        fetch("https://api.escuelajs.co/api/v1/products")
            .then(res => res.json())
            .then(data => setCategories(data.slice(12, 24)))
    }, [])

    return (
        <div className={c.firstProductSwiper}>
            <h4 className={c.firstProductInfo}>Новинка</h4>
...
export default SecondProductsSwiper